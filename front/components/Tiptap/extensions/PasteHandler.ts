...
export const createPasteHandler = (t: (key: string) => string) =>
    Extension.create({
        name: 'pasteHandler',
                                ...
                                const shouldParse = await showDrawer<boolean>({
                                    render: ({ hide }) =>
                                        h(ConfirmActionDrawer, {
                                            title: t('page.editor.markdown.detected'),
                                            desc: t('page.editor.markdown.parsePaste'),
                                            btnLabel: t('page.editor.markdown.confirm'),
